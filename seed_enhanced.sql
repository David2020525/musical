...
INSERT OR IGNORE INTO users (id, email, username, password_hash, name, role, bio, email_verified, instagram_url, twitter_url, spotify_url) VALUES 
...
INSERT OR IGNORE INTO tracks (id, title, artist, album, genre, duration, release_year, audio_url, description, plays_count, likes_count, price, user_id, bpm, mood, tags, is_featured, cover_url) VALUES 
...
INSERT OR IGNORE INTO wallets (user_id, balance, total_earned, total_withdrawn) VALUES 
  (4, 285.50, 845.50, 560.00),
  (5, 412.75, 1236.75, 824.00);

-- Insert sample purchases (user 2 bought tracks from producers)
INSERT OR IGNORE INTO purchases (user_id, track_id, price, transaction_id, payment_method, payment_status) VALUES 
...
INSERT OR IGNORE INTO wallet_transactions (wallet_id, transaction_type, amount, description, reference_type, reference_id) VALUES 
...
INSERT OR IGNORE INTO withdrawals (id, user_id, amount, status, payment_method, payment_details, requested_at, processed_at, processed_by) VALUES 
...
INSERT OR IGNORE INTO user_activities (user_id, activity_type, entity_type, entity_id, description) VALUES 
